...
/**
 * Tests for {@link GraphicsState} defaults, deep copy and per-glyph reset - the three areas that
 * broke prior Java hinting implementations.
 */
class GraphicsStateTest
{
    ...
    void testDefaults()
    {
        ...
        assertEquals(Vector.xAxis(), gs.getProjectionVector());
        assertEquals(Vector.xAxis(), gs.getFreedomVector());
    ...
    void testDeepCopyIsIndependent()
    {
        ...
        assertEquals(Vector.xAxis(), original.getFreedomVector());
