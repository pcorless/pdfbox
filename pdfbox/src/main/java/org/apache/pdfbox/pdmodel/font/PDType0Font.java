...
public class PDType0Font extends PDFont implements PDVectorFont
{
    ...
    {
        // PDCIDFont's default returns null: only PDCIDFontType2 overrides this, so the dispatch
        // alone gives the hinted path for a TrueType-based descendant and null for a CFF-based one.
